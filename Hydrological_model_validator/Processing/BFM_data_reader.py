...
def process_year(year: int,
    ...
    # Construct full path to the compressed model output file for the specified year
    ...
    # Open the decompressed data as an xarray dataset for convenient multidimensional data handling
