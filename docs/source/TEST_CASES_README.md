...
| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST SCAT](Example_Images/Test_data/SST_SCATT.png) | ![Full CHL SCAT](Example_Images/Full_Data/CHL_SCATT.png) |
...
| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/SST_BOX.png) | ![Full CHL BOX](Example_Images/Full_Data/CHL_BOX.png) |
...
| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/MON-MB-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/MON-MB-RAW.png) |

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/MON-MB-DETR.png) | ![Full CHL BOX](Example_Images/Full_Data/MON-MB-DETR.png) |

##### Yearly

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/YEAR-MB-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/YEAR-MB-RAW.png) |

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/YEAR-MB-DETR.png) | ![Full CHL BOX](Example_Images/Full_Data/YEAR-MB-DETR.png) |
...
| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/MON-SDE-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/MON-SDE-RAW.png) |

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/MON-SDE-DETR.png) | ![Full CHL BOX](Example_Images/Full_Data/MON-SDE-DETR.png) |

##### Yearly

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/YEAR-SDE-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/YEAR-SDE-RAW.png) |

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/YEAR-SDE-DETR.png) | ![Full CHL BOX](Example_Images/Full_Data/YEAR-SDE-DETR.png) |
...
| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/MON-CC-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/MON-CC-RAW.png) |

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/MON-CC-DETR.png) | ![Full CHL BOX](Example_Images/Full_Data/MON-CC-DETR.png) |

##### Yearly

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/YEAR-CC-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/YEAR-CC-RAW.png) |

| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/YEAR-CC-DETR.png) | ![Full CHL BOX](Example_Images/Full_Data/YEAR-CC-DETR.png) |
...
| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/MON-URMSE-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/MON-URMSE-RAW.png) |
...
| Test Case Output (1-year) | Full Dataset Output (10-year) |
|---------------------------|-------------------------------|
| ![Test SST BOX](Example_Images/Test_data/YEAR-URMSE-RAW.png) | ![Full CHL BOX](Example_Images/Full_Data/YEAR-URMSE-RAW.png) |
