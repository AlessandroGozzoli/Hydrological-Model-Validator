...
print("Loading the necessary modules from the Hydrological_model_validator library...")

# ----- ADDING ROOT PATH AS A FAILSAFE FOR THE TEST CASE -----
root_path = Path(__file__).resolve().parents[1]  # goes up two levels: from test_script.py to root
sys.path.insert(0, str(root_path))

# ----- RETRIEVING I/O MODULES -----
print("Loading the I/O modules...")
from Hydrological_model_validator.Processing import load_dataset
print("\033[92m✅ I/O modules imported! \033[0m")
print("-"*45)

# ----- RETRIEVING TIME UTILITY MODULES -----
print("Loading the time_utils modules...")
from Hydrological_model_validator.Processing import (
                                                    split_to_monthly, 
                                                    split_to_yearly
                                                    )
print("\033[92m✅ Time_utils modules imported! \033[0m")
print("-"*45)
...
from Hydrological_model_validator.Plotting.Plots import (timeseries_basin_average,
                                                         scatter_plot,
...
# Use deafult options
timeseries_basin_average(BASST, 
                         BIAS, 
                         variable_name='SST', 
                         BA=True, 
                         output_path=output_path)
# Other options to test **kwargs
timeseries_basin_average(BASST,
                         BIAS,
                         variable_name='SST',
                         BA=True,
                         ...
                         figsize=(12, 6),
                         dpi=150,
                         color_palette=itertools.cycle(['#FF0000', '#00FF00', '#0000FF']),
                         title_fontsize=16,
                         label_fontsize=12,
                         legend_fontsize=10,
                         bias_title_fontsize=14,
                         line_width=3,
...
# Default options
plot_monthly_comparison_boxplot(BASST_monthly, 
                                variable_name='SST', 
                                output_path=output_path)
# Kwargs test
plot_monthly_comparison_boxplot(BASST_monthly,
...
# Default options
plot_monthly_comparison_violinplot(BASST_monthly, 
                                   variable_name='SST', 
                                   output_path=output_path)
#Kwargs test
plot_monthly_comparison_violinplot(BASST_monthly,
