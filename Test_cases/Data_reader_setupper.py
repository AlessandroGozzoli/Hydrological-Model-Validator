...
print("Due to the size of the datasets used the processing of both the")
print("Chlorphyll and Sea Surface Temperature dataset cannot be performed")
...
print("The computation for both data levels cannot be handled simultaneously.")
